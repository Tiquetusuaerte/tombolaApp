...
@Component({
    selector: 'app-sorteosTombola',
    templateUrl: './sorteosTombola.page.html',
    styleUrls: ['./sorteosTombola.page.scss'],
    standalone: false
})
export class SorteosTombolaPage implements OnInit {
  ...
  cargarSorteos(){
    this.logica.obtenerReporteSorteosTombola().then((data) => {
      if (data['success']) {
