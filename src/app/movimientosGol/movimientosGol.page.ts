...
@Component({
    selector: 'app-movimientosGol',
    templateUrl: './movimientosGol.page.html',
    styleUrls: ['./movimientosGol.page.scss'],
    standalone: false
})
export class MovimientosGolPage {
  movimientos: any = [];
  ...
  ionViewWillEnter(){
    ...
    this.logica.movimientosGol().then((data) => {
      if (data['success']) {
