...
@Component({
    selector: 'app-movimientosTM',
    templateUrl: './movimientosTM.page.html',
    styleUrls: ['./movimientosTM.page.scss'],
    standalone: false
})
export class MovimientosTMPage {
  movimientos: any = [];
  ...
  ionViewWillEnter(){
    ...
    this.logica.movimientosTM().then((data) => {
      if (data['success']) {
