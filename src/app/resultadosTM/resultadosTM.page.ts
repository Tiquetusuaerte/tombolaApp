...
@Component({
    selector: 'app-resultadosTM',
    templateUrl: './resultadosTM.page.html',
    styleUrls: ['./resultadosTM.page.scss'],
    standalone: false
})
export class ResultadosTMPage implements OnInit {
  ...
  cargarSorteos(){
    this.logica.obtenerReporteSorteosTM().then((data) => {
      if (data['success']) {
