...
@Component({
    selector: 'app-resultadosGol',
    templateUrl: './resultadosGol.page.html',
    styleUrls: ['./resultadosGol.page.scss'],
    standalone: false
})
export class ResultadosGolPage implements OnInit {
  ...
  cargarSorteos(){
    /*this.logica.obtenerReporteSorteosGol().then((data) => {
      if (data['success']) {
